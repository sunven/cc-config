        ...
        {health && (
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-semibold">{Math.round(health.score)}/100</span>
            </div>
            ...
            <div className="flex items-center space-x-4 text-sm">
              {health.metrics.errors > 0 && (
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-red-600 font-medium">{health.metrics.errors} errors</span>
                </div>
              )}
              {health.metrics.warnings > 0 && (
                <div className="flex items-center space-x-1">
                  <AlertTriangle className="h-4 w-4 text-yellow-500" />
                  <span className="text-yellow-600 font-medium">{health.metrics.warnings} warnings</span>
                </div>
              )}
            </div>
          </div>
